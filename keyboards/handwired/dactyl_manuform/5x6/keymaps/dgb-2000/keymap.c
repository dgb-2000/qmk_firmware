...
// PC/Linux: Esc when tapped, Left Ctrl when held
#define ESC_CTL MT(MOD_LCTL, KC_ESC)

// macOS: Esc when tapped, Left Command when held
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC] = LAYOUT_5x6(
        ...
        KC_TAB  , DE_Q    , DE_W    , DE_E    , DE_R    , DE_T    ,                         DE_Z    , DE_U    , DE_I    , DE_O    , DE_P    , DE_UDIA,
        KC_LSFT , DE_A    , DE_S    , DE_D    , DE_F    , DE_G    ,                         DE_H    , DE_J    , DE_K    , DE_L    , DE_ODIA , DE_ADIA,
        ESC_CMD , DE_Y    , DE_X    , DE_C    , DE_V    , DE_B    ,                         DE_N    , DE_M    , DE_COMM , DE_DOT  , DE_MINS , DE_PLUS,
                            DE_LABK , LOWER   ,                                                       DE_RABK , DE_ACUT ,
                                               KC_LCTL  , KC_SPC  ,                         KC_ENT   , RAISE   ,
                                               DE_HASH  , KC_RALT ,                         KC_BSPC  , KC_RGUI ,
                                               LOWER    , KC_LGUI ,                         KC_DEL   , KC_RSFT
    ),
