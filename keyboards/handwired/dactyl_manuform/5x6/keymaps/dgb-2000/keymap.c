...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_5x6(
          ...
          _______,_______,_______,_______,_______,_______,                        _______,_______,_______,KC_INS ,_______,KC_MUTE,
